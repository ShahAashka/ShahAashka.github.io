export default {
    ...
    aboutSection: {
        title: "About Me",
        paraOne: "Greetings! My name is Aashka Acharya, and I am a Master of Science in Information Technology who graduated from Dhirubhai Ambani Institute of Information and Communicarion Technology. Currently residing in Ontario, Canada, I began my professional journey as an itern while still in university, in Jan 2019, I set out to embark on a UI development journey.",
    ...
    contactSection: {
        ...
        paraTwo: "Additionally, if you simply want to connect or have any questions about my work, don't hesitate to drop me a message. Looking forward to hearing from you soon!",
        cta: "Say Hello!"
    }
}